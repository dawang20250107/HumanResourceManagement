...
export interface Demand { id: string; clientId: string; title: string; role: string; city: string; headcount: number; status: ApprovalStatus; budgetPerHour: number; }
...
export interface AuditEvent { id: string; at: string; message: string; module: ModuleKey; }
